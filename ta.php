...
function valuech()
{
      ...
      if (x==="A") 
      {
		...
		document.getElementById("chimg").src="images/ex2/1.gif";

      }
      if (x=="B") 
      {
      	document.getElementById("chimg").src="images/ex2/2.gif";
      }
      if (x=="C") 
      {
      	document.getElementById("chimg").src="images/ex2/3.gif";
      }
      if (x=="D") 
      {
      	document.getElementById("chimg").src="images/ex2/4.gif";
      }
       if (x=="E") 
      {
        document.getElementById("chimg").src="images/ex2/1.gif";
